...
const diagrams = [
  ...
  buildDiag({
    title: '十字围获胜',
    desc: '当对方棋子的东、南、西、北四个相邻位置均为己方棋子时，立即获胜。',
    cols: 5, rows: 5,
    stones: S([2, 2, BLACK], [1, 2, WHITE], [3, 2, WHITE], [2, 1, WHITE], [2, 3, WHITE]),
    marks: M([2, 2, 'circle'])
  }),
  // 2. 斜角围获胜
  buildDiag({
  ...
  buildDiag({
    ...
    cols: 5, rows: 5,
    stones: S([2, 0, BLACK], [1, 0, WHITE], [3, 0, WHITE], [2, 1, WHITE]),
    marks: M([2, 0, 'circle']),
    boundary: ['left']
  }),
  // 4. 边缘斜角围获胜
  ...
  buildDiag({
    title: '竖向双排判负',
    desc: '两条相邻竖向连续棋子，每条长度大于3，立即判负。',
    cols: 4, rows: 6,
    stones: S(
      [1, 1, WHITE], [2, 1, WHITE], [3, 1, WHITE], [4, 1, WHITE],
      [1, 2, WHITE], [2, 2, WHITE], [3, 2, WHITE], [4, 2, WHITE]
    ),
